...
#if !defined ANT_TW_DIRECT3D8_INCLUDED
#define ANT_TW_DIRECT3D8_INCLUDED

#include "TwGraph.h"

//  ---------------------------------------------------------------------------

class CTwGraphDirect3D8 : public ITwGraph
{
public:
    virtual int                 Init();
    virtual int                 Shut();
...
protected:
    struct IDirect3DDevice8 *   m_D3DDev;
    bool                        m_Drawing;
    const CTexFont *            m_FontTex;
    struct IDirect3DTexture8 *  m_FontD3DTex;
    bool                        m_PureDevice;
    int                         m_WndWidth;
    int                         m_WndHeight;
    void *                      m_ViewportInit;
    ...
    struct CState8 *             m_State;
    void SetFVF8(IDirect3DDevice8* device, DWORD dwFVF);
};

//  ---------------------------------------------------------------------------


#endif // !defined ANT_TW_DIRECT3D8_INCLUDED
